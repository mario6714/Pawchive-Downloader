...
If you discover a potential security vulnerability in Pawchive Downloader, we appreciate your assistance in disclosing it responsibly.
...
1. **Acknowledgement**: We aim to acknowledge receipt of genuine reports within 5–7 business days.
2. **Assessment**: The maintainers will investigate and determine the validity, severity, and feasibility of a patch.
3. **Resolution**: If confirmed, a fix will be developed and released in an upcoming update. We kindly ask researchers to allow reasonable time for a patch before public disclosure.
...
> [!IMPORTANT]
> **READ CAREFULLY:** Pawchive Downloader is a free, open-source personal utility developed and maintained by volunteers for educational and personal archiving purposes.
...
2. **No Accountability or Legal Liability**:
   To the maximum extent permitted by applicable law, in no event shall the authors, maintainers, contributors, or copyright holders be held liable for any claim, damages, losses, costs, or liabilities (whether in contract, tort, negligence, strict liability, or otherwise) arising out of or in connection with:
   ...
   - Any malicious modification, unauthorized fork, or repackaged binaries distributed outside our official repository release page.

3. **No Service Level Agreement (SLA)**:
   The maintainers have no legal, financial, or contractual obligation to remediate, patch, or respond to reported vulnerabilities or issues within any guaranteed timeframe or at all.
...
Security researchers who discover potential vulnerabilities and report them in good faith, in accordance with this policy, will be treated with courtesy. The maintainers will not pursue legal action against researchers who:
